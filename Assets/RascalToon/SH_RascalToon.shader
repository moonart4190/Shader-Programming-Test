...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;146;-1823.813,448;Inherit;False;3027.514;658.3557;Directional Light의 그림자를 생성;25;559;558;557;560;210;104;213;80;82;84;241;234;81;94;95;92;354;355;788;789;792;793;794;796;805;Main Light Shadow;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;311;-880,-1104;Inherit;False;2981.08;599.1187;Specular 연산;23;332;347;315;389;387;320;318;327;317;325;340;319;363;292;341;321;339;337;343;548;549;706;755;Additional Specular;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;148;1321.553,736;Inherit;False;1735.114;614.553;LIGHTMAP_ON 키워드를 사용하여 라이트맵이 사용중인 메쉬에는 Lightmap으로 GI를 사용, 그렇지 않은 경우에는 SRP Baked GI를 사용한다.;16;533;529;130;115;528;527;214;526;394;434;435;157;218;133;131;607;Global Illumination;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;147;240,-2928;Inherit;False;1806.679;520.7145;그림자 색상을 결정하고, 그림자 영역과 빛 영역을 Lerp로 구분;15;108;522;524;523;396;111;167;356;357;217;98;107;100;719;736;Shadow Color;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;139;-560,128;Inherit;False;1059;286.3333;추가 라이트의 그림자와 색상을 생성;6;135;173;172;170;346;734;Additional Light;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;343;1120,-640;Inherit;False;408;100;;추가 작업;1,1,1,1;Shadow가 VdotL로 연산되는거 같음....;0;0
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;351;1744,208;Inherit;False;359;100;New Note;라이트 관련 경고;1,0,0,1;Main Light 사용 시 반드시 Mixed로 사용$Main Light Attenuation 노드가 Baked 라이트에는 작동 안함;0;0
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;352;1440,400;Inherit;False;744.9999;174;New Note;(해결)Additional + Directional Light 합산 문제;1,1,1,1;지금 Additional과 Directional의 Shadow Attenuation 이 Max로 합쳐져 라이트 컬러 연산 Lerp에 같이 들어가고 있음.$Main Light Color가 Additional Light의 영역에도 묻어나오는 현상 발생.$특히 그림자 아래에서 Additional Light 연산이 적용되는 경우에 그러함.$Additional Light와 Main Light의 그림자 연산을 따로 해야하고, Main Light의 Shadow Atten으로 Main Light Color의 영역을 마스킹하는 작업이 필요함.;0;0
...
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;519;3600,-2560;Inherit;False;732.6665;134;New Note;;1,1,1,1;Static Switch(_OUTLINEON_ON)은 임시로 제작. 패스 2개를 쓰지 않는 방향으로 최적화 할 것.$앰플리파이 문의 결과, 아웃라인 쓰지 않는 머티리얼의 경우 그냥 쉐이더 분리하는 게 나을수도 있다고 그럼.;0;0
...
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;805;-784,512;Inherit;False;434;100;!!;;1,1,1,1;Main Light Attenuation노드가 Half + 0.5 된 그림자값을 제공함;0;0
